...
//-----------------------------------------------------------------------------
Phone::Phone(api::Interface *api) : api_(api), gui_handler_(NULL)
{
...
//-----------------------------------------------------------------------------
void Phone::set_GUI_Handler(GUI_Handler *gui_handler)
{
    gui_handler_ = gui_handler;
}
...
void Phone::slotMicroLevel(int level)
{
    if( gui_handler_)
    {
        gui_handler_->microphoneLevel(level);
    }
}
...
void Phone::slotAccountState(const int state)
{
    if( gui_handler_)
    {
        gui_handler_->accountStateChanged(state);
    }
}
...
void Phone::slotIncomingTextMessage(int call_id, const QString &from, const QString &to, const QString &contact, const QString &mime_type, const QString &body)
{
    if( gui_handler_ )
    {
        gui_handler_->receivedIncomingTextMessage(call_id,from,to,contact,mime_type,body);
    }
}
